...
const sendEmail = require("../../../TFM_Backend/utils/emailService");
const inviteController = require("../../../TFM_Backend/controllers/inviteController");
...
describe("inviteController", () => {
  ...
  describe("sendInviteToken", () => {
    ...
    it("should handle errors and return 500", async () => {
      req.body = { email: "driver@example.com" };
      InviteToken.mockImplementation(() => ({
