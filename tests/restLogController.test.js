...
const restLogController = require("../../../TFM_Backend/controllers/restLogController");
  ...
  describe("endRestAndStartDrive", () => {
    ...
    it("should end rest, start drive, and notify users", async () => {
      ...
      expect(notifyUser).toHaveBeenCalledWith(
        "user123",
        expect.stringContaining("Rest ended. Drive session resumed.")
      );
      expect(notifyUser).toHaveBeenCalledWith(
        "owner123",
        expect.stringContaining("has resumed driving after a rest")
      );
